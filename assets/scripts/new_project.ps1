...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    ...
    <Grid Margin="20">
        ...
        <TextBlock Grid.Row="0" Text="Enter project name:" Foreground="$fg"
                   FontFamily="Segoe UI" FontSize="14" Margin="0,0,0,10"/>
        <TextBox Grid.Row="1" x:Name="ProjectName"
...
$nameBox = $window.FindName("ProjectName")
...
if ($window.ShowDialog() -and $nameBox.Text.Trim()) {
    ...
    $destPath = Join-Path $TargetDir $projectName
