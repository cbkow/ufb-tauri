...
/// Linux mount mapping using symlinks.
/// The user-facing path (e.g. /mnt/nas) is a symlink pointing to the SMB mount path.
pub struct LinuxMountMapping;

impl LinuxMountMapping {
    pub fn new() -> Self {
        Self
    }
}

impl DriveMapping for LinuxMountMapping {
